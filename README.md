...
## CDR取込（接続層・2026-07-14 フェーズ2完了＝cron稼働中）
...
- cron（**稼働中**・smileadmin crontab）: `8,23,38,53 * * * * /var/www/naisen-app/scripts/pull_cdr.sh >> /var/www/naisen-app/logs/cdr-pull.log 2>&1`
